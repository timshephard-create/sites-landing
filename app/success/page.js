  ...
  return (
    <main style={{ fontFamily: 'Georgia, serif', background: '#F7F3EE', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      <div style={{ maxWidth: '560px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: '0.85rem', color: '#9A9490' }}>Didn't get it? Check your spam folder or <a href="mailto:tim@timshephard.co" style={{ color: '#C8522A' }}>email me directly</a>.</p>
